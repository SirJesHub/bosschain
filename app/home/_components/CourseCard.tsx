...
export default function CourseCard({
  ...
  return (
    <div className="group relative h-full bg-gradient-to-b from-gray-300 to-white rounded-md">
    ...
    <Highlight attribute="desc" hit={hit} />
      ...
      <div className="group opacity-0 absolute top-0 trasition duration-200 z-10 invisible sm:visible delay-300 w-full scale-0 group-hover:scale-110 group-hover:opacity-100">
        <Image
          ...
          height={400}
        />
        <div className="z-10 bg-white lg:p-2 absolute w-full transition shadow-md rounded-b-md text-black">
          ...
          <button className=" m-1 py-2 px-3 rounded-3xl text-white bg-blue-500 hover:bg-blue-600 active:bg-blue-700 focus:outline-none focus:ring focus:ring-orange-300">
            Start Learning
          </button>
        </div>
      </div>
