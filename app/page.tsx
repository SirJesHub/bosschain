  ...
  return (
    <div className="bg-blue-600 h-full box-border w-full overflow-x-hidden">
      ...
      <div className="bg-gradient-to-br from-gray-100 to-white p-10 flex flex-row h-max">
        <AnimateOnScroll direction="top">
          <div className="w-full p-10 pt-24 flex flex-col justify-start items-center box-border text-transparent bg-clip-text bg-gradient-to-br from-blue-800 to-blue-700">
            <div>
