...
export const TitleForm = ({
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const data = await EnrollmentService.updateLessonTitle({
      ...
      if (
        ...
        console.log("[updateLessonTitle ERROR]: ", data.error);
      ...
      console.error("[updateLessonTitle ERROR]: ", error);
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input
                      placeholder="e.g. 'What is cryptocurrency'"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
